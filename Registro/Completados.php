            ...
            <div class="row" id="row-recomendados">
                <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 ">
                    <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                        ...
                        <div class="nav-link active">&nbsp;&nbsp; Completados</div>
                ...
                <div class="col-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                    <div class="text-center">
                        <h1 class="color-text h1-style">Cursos Completados</h1>
                        <!-- En el parrafo debe ser dinamico, haciendo una peticion a los cursos completados. -->
                        <p class="color-text p-style">
                            No tienes cursos completados en este momento.
                        </p>
                        <img class="img-160" src="../img/enrollments_empty_state_complete.png" alt="Completados">
