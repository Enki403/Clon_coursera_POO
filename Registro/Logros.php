            ...
            <div class="row" id="row-recomendados">
                <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                    <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                        ...
                        <div class="nav-link active">Logros</div>
                        <a href="index" role="tab" aria-controls="#" aria-selected="true">
                ...
                <div class="col-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                    <div class="text-center">
                        <!-- card de verificacion de perfil -->
                        <img src="../img/catalog-book-icon.png" alt="Catalago">
                        <button class="btn-primary">Explorar Catalago</button>
                    </div>
                </div>
            </div>
        </div>
