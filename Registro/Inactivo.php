...
<head>
    ...
    <title>Coursera | Online Courses & Credentials From Top Educators. Join for Free</title>
            ...
            <div class="row" id="row-recomendados">
                <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                    <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                        ...
                        <div class="nav-link active">&nbsp;&nbsp; Inactivo</div>
                        ...
                        <a href="index" role="tab" aria-controls="#"
                            aria-selected="true">
                            <div class="nav-link">Recomendaciones</div>
                        </a>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                    <div class="text-center">
                        <h1 class="color-text h1-style">Cursos inactivos</h1>
                        <!-- En el parrafo debe ser dinamico, haciendo una peticion a los cursos completados. -->
                        <p class="color-text p-style">
                            No tienes cursos inactivos en este momento.
                        </p>
                        <img class="img-160" src="../img/enrollments_empty_state_inactive.png" alt="Inactivo">
                        <a href="../PaginasSuperficiales\Paginas\browse.html"><button class="btn-primary">Explorar Catalago</button></a>
                    </div>
